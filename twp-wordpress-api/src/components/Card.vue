  ...
  >
    <template v-slot:top>
      ...
      mdi-dialpad
        ...
        <v-toolbar-title>Trellio, speed up your productivity</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
  ...
  export default {
    name: 'HelloWorld',
     data: () => ({
        config:{
            headers:{
               Authorization: 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL3dvcmRwcmVzcyIsImlhdCI6MTYxNjcwODA5NywibmJmIjoxNjE2NzA4MDk3LCJleHAiOjE2MTczMTI4OTcsImRhdGEiOnsidXNlciI6eyJpZCI6IjEifX19.FPlVu7yGjJNyscUufhkkJWcOHlJZv1j4p7hXEw-Hnqo'
            }
        },
      dialog: false,
      dialogDelete: false,
