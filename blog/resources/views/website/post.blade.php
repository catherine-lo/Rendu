...
<div class="row" id="header">
    ...
    <div class="card text-center" id="bigNouvelle">
        <div class="card-header">
          <img src="{{ $post->image }}" id="imgNouvelle">
        </div>
        <div class="card-body">
          <h5 class="card-title" id="titleBigCard">{{ $post->title }}</h5>
          <p class="card-text" id="textBigCard" style="color: white !important; ">{!! $post->description !!} </p>

          <div class="pt-5" id="textBigCard">
                    <p id="textBigCard">
