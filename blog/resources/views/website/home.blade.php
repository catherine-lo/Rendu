...
<body>
    ...
    <div class="bookWrap">
		<div class="book">
			<a target="_blank" href="https://livre.fnac.com/a14646323/Daniel-Hortofer-Athena-et-la-guerre-des-genes#int=:NonApplicable|NonApplicable|NonApplicable|14646323|NonApplicable|NonApplicable"><img class="cover" 
                src="{{ asset('website/images/livre.jpg') }}"></a>
			<div class="spine"></div>
		</div>
	</div>
